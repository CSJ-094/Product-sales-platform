...
<head>
    ...
    <style>
        ...
        :root {
            /* Default Theme: Customer (now Dark Gray) */
        ...
        * {
        ...
        body {
            ...
            height: 100vh;
            position: relative;
            /* Now Dark Gray Gradient for customer */
        ...
        body::after {
            ...
            /* Now Medium Gray Gradient for seller */
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const loginForm = document.querySelector('.login-panel form'); // Assuming the form is within .login-panel
        ...
        loginForm.addEventListener('submit', (event) => {
            if (rememberMeCheckbox.checked) {
                setCookie('savedUsername', usernameField.value, 30); // Save for 30 days
            } else {
                eraseCookie('savedUsername');
            }
            // The form will submit normally after this.
            // Server-side will need to handle reading the 'remember' parameter
            // and setting/deleting the cookie on the server as well for full auto-login.
        });
    });
</script>
