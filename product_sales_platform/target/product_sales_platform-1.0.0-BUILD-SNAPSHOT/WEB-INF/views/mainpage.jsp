...
<main class="main-content">
	<section class="recommend-section">
		...
		<div class="product-grid">
			<c:choose>
				<c:when test="${empty mansRecommendList}">
					<p style="grid-column: span 4; color: #777;">
						현재 MANS 추천 상품 기능 준비 중입니다.
					</p>
				</c:when>
				<c:otherwise>
					<c:forEach var="imagePath" items="${mansRecommendList}">
						<div class="product-item">
							<div class="product-img">
								<img src="<c:url value='${imagePath}'/>" alt="MANS 추천 상품">
							</div>
		...
		<div class="product-grid">
			<c:choose>
				<c:when test="${empty womansRecommendList}">
					<p style="grid-column: span 4; color: #777;">
						현재 WOMEN 인기 상품 기능 준비 중입니다.
					</p>
				</c:when>
				<c:otherwise>
					<c:forEach var="imagePath" items="${womansRecommendList}">
						<div class="product-item">
							<div class="product-img">
								<img src="<c:url value='${imagePath}'/>" alt="WOMEN 인기 상품">
							</div>
							<div class="product-info">
								<p>WOMEN 인기 상품</p>
								<span>₩ 00,000</span>
