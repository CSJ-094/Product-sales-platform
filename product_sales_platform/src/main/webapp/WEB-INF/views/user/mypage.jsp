                ...
                <c:when test="${sessionScope.memberId eq 'admin'}">
                    <div id="member-management-content" class="content-panel active">
                        ...
                        <c:if test="${empty memberList}">
                            <p class="no-items">등록된 회원이 없습니다.</p>
                        </c:if>
                                ...
                                <tbody>
                                    <c:forEach var="member" items="${memberList}">
                                        <tr>
                                            ...
                                            <td>
                                                <form action="<c:url value='/admin/member/delete'/>" method="post" style="display:inline;" onsubmit="return confirm('정말 이 회원을 삭제하시겠습니까? 관련 데이터가 모두 삭제될 수 있습니다.');">
                                                    <input type="hidden" name="memberIdToDelete" value="${member.memberId}">
                                ...
                                <tbody>
                                    <c:forEach var="product" items="${productList}">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<c:url value='/product/admin/edit?prodId=${product.prodId}'/>" class="action-btn">수정</a>
                                ...
                                <tbody>
                                    <c:forEach var="cartItem" items="${cartList}">
                                        ...
                                        <tr>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${not empty cartItem.prodImage}">
                                                        <img src="${pageContext.request.contextPath}${cartItem.prodImage}" alt="${cartItem.prodName}" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img src="${pageContext.request.contextPath}/resources/images/default_product.png" alt="${cartItem.prodName}" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                ...
                                <tbody>
                                    <c:forEach var="product" items="${wishlist}">
                                        <tr>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${not empty product.prodImage}">
                                                        <img src="${pageContext.request.contextPath}${product.prodImage}" alt="${product.prodName}" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img src="${pageContext.request.contextPath}/resources/images/default_product.png" alt="${product.prodName}" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            ...
                                            <td>
                                                <form action="${pageContext.request.contextPath}/cart/moveFromWishlist" method="post" style="display:inline;">
                                                    <input type="hidden" name="memberId" value="${param.memberId}">
                                                    <input type="hidden" name="prodId" value="${product.prodId}">
                                ...
                                <tbody>
                                    <c:forEach var="order" items="${orderList}">
                                        <tr>
                                            <td>
                                                <c:choose>
                                                    <c:when test="${not empty order.orderMainImage}">
                                                        <img src="${pageContext.request.contextPath}${order.orderMainImage}" alt="주문 상품" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <img src="${pageContext.request.contextPath}/resources/images/default_product.png" alt="기본 이미지" style="width: 50px; height: 50px; object-fit: cover;"/>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
                                            <td>${order.ordId}</td>
            ...
            function activatePanel(targetId) {
                ...
                sidebarLinks.forEach(link => {
                    ...
                    if (linkHash === targetId) {
                        ...
                        mainTitle.textContent = link.textContent; // 사이드바 링크 텍스트를 메인 타이틀로 설정
                    } else {
